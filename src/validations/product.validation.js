...
const createProduct = {
  body: Joi.object({
    ...
    area: Joi.object({
      ...
      decks: Joi.number().allow(""),
      garage: Joi.number().allow(""),
      lower_floor: Joi.number().allow(""),
      main_floor: Joi.number().allow(""),
      patios: Joi.number().allow(""),
      upper_floor: Joi.number().allow(""),
    }),
    ceiling: Joi.object({
      ceiling_details: Joi.string().trim().required(),
      main_ceiling: Joi.string().trim().allow(""),
      upper_ceiling: Joi.string().trim().allow(""),
      additional_ceiling: Joi.string().trim().allow(""),
    }),
    roof: Joi.object({
      primary_pitch: Joi.string().trim().required(),
      roof_framing: Joi.string().trim().allow(""),
      roof_load: Joi.string().trim().allow(""),
      roof_type: Joi.string().trim().allow(""),
    }),
    exterior_wall_framing: Joi.object({
      framing: Joi.string().trim().allow(""),
      insulation: Joi.string().trim().allow(""),
    }),
    ...
    childSubCategory: Joi.string().trim().allow(""),
